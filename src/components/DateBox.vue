<template>
  <div class="cal-date-box" :class="isToday ? 'current' : ''">
      ...
      <div class="cal-date-evt-cnt">
          <div v-for="n in (1,3)" :key="n" class="cal-date-evt">
              <span class="cal-date-evt-icn"></span>
              <span class="cal-date-evt-time">{{'10.00 A.M'}}</span>
              <span class="cal-date-evt-txt">{{'- Coffee with Denis'}}</span>
          </div>
      </div>
  </div>
</template>
...
.cal-date-box {
    ...
    .cal-date-evt-cnt {
        ...
        .cal-date-evt {
            ...
            .cal-date-evt-time, .cal-date-evt-txt {
                color: #333333;      
                vertical-align: middle;     
            }
        }
